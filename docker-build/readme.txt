...
How to pull the docker images:
    docker pull bme855/game-benchvnc:0.1
or  docker pull bme855/game-benchvnc:0.2
...
How to build:
    ...
    docker build -t bme855/game-benchvnc:0.2 .   //it will be easier when you push to docker hub
